            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center w-full">
                <div className="space-y-10">
                    <div className="space-y-6">
                        ...
                        <p className="text-lg lg:text-xl text-ink-mute max-w-lg leading-relaxed font-medium">
                    ...
                    <div className="flex flex-wrap gap-6">
                        ...
                        <button className="px-10 py-4 rounded-full font-bold hover:bg-white/5 transition-all transform hover:-translate-y-1">
                            Watch 2-min Demo
                        </button>
                    </div>
                </div>
                ...
                <div className="relative flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-md aspect-square">
                        ...
                        <div className="absolute inset-0 rounded-full border border-white/5 flex items-center justify-center">
                            ...
                            {/* Central Node */}
                            <div className="w-32 h-32 rounded-full border-white/10 flex items-center justify-center z-10 shadow-2xl">
                                <div className="text-center">
                                    <div className="text-[10px] text-ink-dim uppercase tracking-widest mb-1">Status</div>
                                    <div className="text-accent font-bold text-sm">ANALYZING...</div>
                                </div>
                            </div>

                            {/* Agent Nodes */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full border-bull/30 flex items-center justify-center shadow-[0_0_25px_rgba(34,197,94,0.15)] bg-[#0A1A10]">
                                <span className="text-bull font-bold text-xs uppercase">Bull</span>
                            </div>
                            <div className="absolute bottom-10 right-0 w-20 h-20 rounded-full border-bear/30 flex items-center justify-center shadow-[0_0_25px_rgba(239,68,68,0.15)] bg-[#1A0A0A]">
                                <span className="text-bear font-bold text-xs uppercase">Bear</span>
                            </div>
                            <div className="absolute bottom-10 left-0 w-20 h-20 rounded-full border-quant/30 flex items-center justify-center shadow-[0_0_25px_rgba(59,130,246,0.15)] bg-[#0A101A]">
