    ...
    return (
        <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center justify-between px-8 py-4 glass rounded-full w-[90%] max-w-7xl shadow-2xl">
            ...
            <div className="flex items-center gap-4">
                ...
                <SignedIn>
                    <Link href="/dashboard" className="px-6 py-2.5 bg-accent text-background rounded-full text-xs font-black uppercase tracking-wider hover:scale-105 transition-all shadow-xl flex items-center">
                        Dashboard
                    </Link>
